                ...
                <div className="flex gap-2">
                  ...
                  <Select value={fromHour} onValueChange={setFromHour}>
                    ...
                    <SelectContent className="max-h-[200px]">
                      {HOUR_SLOTS.map(s => <SelectItem key={s.value} value={s.value}>{s.label}</SelectItem>)}
                    </SelectContent>
                  </Select>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card>
          <CardContent className="flex items-center gap-4 p-5">
            <div className="p-3 rounded-xl bg-primary/10"><LogIn className="w-5 h-5 text-primary" /></div>
            <div>
        ...
        <Card>
          <CardContent className="flex items-center gap-4 p-5">
            <div className="p-3 rounded-xl bg-primary/10"><Eye className="w-5 h-5 text-primary" /></div>
            <div>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <Avatar className="h-7 w-7">
                          ...
                          <AvatarFallback className="text-xs">{(a.profiles?.full_name || '?')[0]}</AvatarFallback>
                        </Avatar>
                        <span className="text-sm truncate max-w-[120px]">{a.profiles?.full_name || 'Unknown'}</span>
                      </div>
                    </TableCell>
                    <TableCell>
