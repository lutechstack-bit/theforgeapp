 ...
 const Perks: React.FC = () => {
   ...
   return (
     <div className="page-container max-w-4xl mx-auto pb-safe">
       ...
       {/* Acceptance Card - Compacted */}
       <div className="mb-6 md:mb-8 relative overflow-hidden rounded-2xl md:rounded-3xl bg-gradient-to-br from-primary/15 via-card to-card border border-primary/20">
         {/* Decorative elements */}
         <div className="absolute top-0 right-0 w-32 md:w-48 h-32 md:h-48 bg-primary/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
         
         <div className="relative p-4 md:p-6">
           <div className="flex items-start justify-between mb-4 gap-3">
             <div className="flex items-center gap-3">
               <div className="w-9 h-9 md:w-10 md:h-10 rounded-xl bg-gradient-to-br from-primary/30 to-primary/10 flex items-center justify-center border border-primary/20">
           ...
           <button
             onClick={handleShare}
             className="w-full py-3 md:py-3.5 rounded-xl bg-gradient-to-r from-primary to-deep-gold text-primary-foreground font-bold flex items-center justify-center gap-2 hover:shadow-gold-glow transition-all duration-300 group active:scale-[0.98]"
           >
       ...
       {/* Forge Bag Section - Moved to bottom */}
       <div className="mb-6 md:mb-8">
         <div className="flex items-center gap-3 mb-4 md:mb-5">
           <div className="w-9 h-9 md:w-10 md:h-10 rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center border border-primary/20">
