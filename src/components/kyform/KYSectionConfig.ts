...
const KYF_SECTIONS: KYSection[] = [
  ...
  },
  {
    ...
    introDescription: "A few more things so we can make your Forge experience comfortable and safe.",
    keepHandy: [
      { emoji: '👕', text: 'Your T-shirt size' },
      { emoji: '📞', text: 'Emergency contact details' },
      { emoji: '💊', text: 'Any medication or allergy info' },
    ],
    ...
    steps: [
      {
        ...
        subtitle: 'Dietary and safety details',
        fields: [
          ...
          { key: 'food_allergies', type: 'text', label: 'Food Allergies', placeholder: 'List any allergies, or type "None"', required: true },
          { key: 'medication_support', type: 'text', label: 'Medication / Medical Support', placeholder: 'Any medication or medical needs, or type "None"', required: true },
          { key: 'emergency_contact_name', type: 'text', label: 'Emergency Contact Name', placeholder: 'Full name of your emergency contact', required: true },
...
const KYC_SECTIONS: KYSection[] = [
  ...
  },
  {
    ...
    icon: '🍽️',
    introTitle: 'Almost there! Final details',
    introDescription: "A few more things so we can make your stay comfortable.",
    keepHandy: [
      { emoji: '📞', text: 'Emergency contact details' },
    ],
    timeEstimate: '~2 minutes',
...
const KYW_SECTIONS: KYSection[] = [
  ...
  },
  {
    ...
    icon: '🍽️',
    introTitle: 'Almost there! Final details',
    introDescription: "A few last things for your comfort and safety at Forge.",
    keepHandy: [
      { emoji: '📞', text: 'Emergency contact details' },
    ],
    timeEstimate: '~2 minutes',
