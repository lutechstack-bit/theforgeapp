  ...
  return (
    <div className="relative mb-6 md:mb-8">
      <div className="relative overflow-hidden rounded-2xl h-[180px] sm:h-[200px]">
        ...
        {/* Content */}
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3.5 text-center px-6 animate-fade-in">
          {/* Icon with glow */}
          <div
          ...
          <div className="flex flex-col items-center gap-1.5">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground [&>span]:text-primary">
              {title}
            </h1>
