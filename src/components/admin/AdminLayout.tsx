...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/admin/email/audiences', icon: BookMarked, label: 'Audiences' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/admin/automation-history', icon: ScrollText, label: 'History' },
      { to: '/admin/sheet-viewer', icon: FileSpreadsheet, label: 'Sheet Viewer' },
    ],
  },
  {
    label: 'System',
