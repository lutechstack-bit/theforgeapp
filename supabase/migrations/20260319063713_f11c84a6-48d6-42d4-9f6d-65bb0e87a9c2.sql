...
BEGIN
  IF OLD.payment_status IS DISTINCT FROM NEW.payment_status THEN
    ...
    IF NEW.payment_status = 'CONFIRMED_15K' THEN
      INSERT INTO public.payment_config (user_id, programme_total, deposit_paid, deposit_label, payment_link, installment_link)
      VALUES (
        NEW.id,
    ...
    ELSIF NEW.payment_status = 'BALANCE_PAID' THEN
      INSERT INTO public.payment_config (user_id, programme_total, deposit_paid, deposit_label)
      VALUES (
        NEW.id,
        COALESCE(edition_defaults.programme_total, 85000),
        COALESCE(edition_defaults.programme_total, 85000),
